...
<html lang="en">
  ...
  <body>
    ...
    <section style="background-image: url('images/banner133.jpg');background-repeat: no-repeat;background-size: cover;">
      <div class="container-lg">
        <div class="row">
          <div class="col-lg-6 pt-5 mt-5">
            <h2 class="display-1 ls-1"><span class="fw-bold text-primary">SMYM</span><span class="text-light">KOOVAPPALLY</span></h2>
            <p class="fs-4">St. Joseph's Church Koovappally.</p>
            <div class="d-flex gap-3">
              <a href="https://www.instagram.com/smym_koovappally_?igsh=cG03YW42NmtnYW90" class="btn btn-primary text-uppercase fs-6 rounded-pill px-4 py-3 mt-3">instagram</a>
              <a href="https://www.instagram.com/smym_koovappally_?igsh=cG03YW42NmtnYW90" class="btn btn-dark text-uppercase fs-6 rounded-pill px-4 py-3 mt-3">Join Now</a>
            </div>
            <div class="row my-5">
              <div class="col">
                <div class="row text-dark">
                  <div class="col-auto"><p class="fs-1 fw-bold lh-sm mb-0">3k+</p></div>
                  <div class="col"><p class="text-uppercase lh-sm mb-0">FOLLOWERS</p></div>
                </div>
              </div>
              <div class="col">
                <div class="row text-dark">
                  <div class="col-auto"><p class="fs-1 fw-bold lh-sm mb-0">52+</p></div>
                  <div class="col"><p class="text-uppercase lh-sm mb-0">FOLLOWING</p></div>
                </div>
              </div>
              <div class="col">
                <div class="row text-dark">
                  <div class="col-auto"><p class="fs-1 fw-bold lh-sm mb-0">61+</p></div>
                  <div class="col"><p class="text-uppercase lh-sm mb-0">POSTS</p></div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="section-header d-flex flex-wrap justify-content-between mb-5">
              <h2 class="section-title">EXECUTIVES 2024-2025</h2>
            ...
            <div class="category-carousel swiper">
              <div class="swiper-wrapper">
                <a href="category.html" class="nav-link swiper-slide text-center">
                  <img src="images/th6.jpg" class="rounded-circle" alt="Category Thumbnail">
                  <h4 class="fs-6 mt-3 fw-normal category-title">fr.mathew puthumana</h4>
                  <h4 class="fs-6 mt-3 fw-normal category-title">(DIRECTOR)</h4>
                </a>
                <a href="category.html" class="nav-link swiper-slide text-center">
                  <img src="images/th11.jpg" class="rounded-circle" alt="Category Thumbnail">
                  <h4 class="fs-6 mt-3 fw-normal category-title">FR.</h4>
                  <h4 class="fs-6 mt-3 fw-normal category-title">(ASST.DIRECTOR)</h4>
                </a>
                <a href="category.html" class="nav-link swiper-slide text-center">
                  <img src="images/th5.jpg" class="rounded-circle" alt="Category Thumbnail">
                  <h4 class="fs-6 mt-3 fw-normal category-title">SR.KOCHURANI SH</h4>
                  <h4 class="fs-6 mt-3 fw-normal category-title">(ANIMATOR)</h4>

                </a>
                <a href="category.html" class="nav-link swiper-slide text-center">
                  <img src="images/th2.jpg" class="rounded-circle" alt="Category Thumbnail">
                  <h4 class="fs-6 mt-3 fw-normal category-title">AJO VANTHIYIL</h4>
                  <h4 class="fs-6 mt-3 fw-normal category-title">(PRESIDENT)</h4>
                </a>
                <a href="category.html" class="nav-link swiper-slide text-center">
                  <img src="images/th12.jpg" class="rounded-circle" alt="Category Thumbnail">
                  <h4 class="fs-6 mt-3 fw-normal category-title">GRESHMA PAYYANATTU</h4>
                  <h4 class="fs-6 mt-3 fw-normal category-title">(VICE PRESIDENT)</h4>
                </a>
                <a href="category.html" class="nav-link swiper-slide text-center">
                  <img src="images/th4.jpg" class="rounded-circle" alt="Category Thumbnail">
                  <h4 class="fs-6 mt-3 fw-normal category-title">JERIN KOCHUVEETTIL</h4>
                  <h4 class="fs-6 mt-3 fw-normal category-title">(GENERAL SECRETARY)</h4>
                </a>
                <a href="category.html" class="nav-link swiper-slide text-center">
                  <img src="images/th9.jpg" class="rounded-circle" alt="Category Thumbnail">
                  <h4 class="fs-6 mt-3 fw-normal category-title">JOBIN MUKHALAYIL</h4>
                  <h4 class="fs-6 mt-3 fw-normal category-title">(TREASURER)</h4>
                </a>
                <a href="category.html" class="nav-link swiper-slide text-center">
                  <img src="images/th8.jpg" class="rounded-circle" alt="Category Thumbnail">
                  <h4 class="fs-6 mt-3 fw-normal category-title">SONY THEVARKATTIL</h4>
                  <h4 class="fs-6 mt-3 fw-normal category-title">(MEDIA COORDINATOR)</h4>
                </a>
                <a href="category.html" class="nav-link swiper-slide text-center">
                  <img src="images/th10.jpg" class="rounded-circle" alt="Category Thumbnail">
                  <h4 class="fs-6 mt-3 fw-normal category-title">ANN MARIA AAYILA</h4>
                  <h4 class="fs-6 mt-3 fw-normal category-title">(COUNCILLOR)</h4>
                </a>
                <a href="category.html" class="nav-link swiper-slide text-center">
                  <img src="images/th7.jpg" class="rounded-circle" alt="Category Thumbnail">
                  <h4 class="fs-6 mt-3 fw-normal category-title">REJO ADIMACKAL</h4>
                  <h4 class="fs-6 mt-3 fw-normal category-title">(COUNCILLOR)</h4>
                </a>
    ...
    <section class="pb-5">
      <div class="container-lg">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="section-header d-flex flex-wrap justify-content-between my-4">
              ...
              <h2 class="section-title">TEAM WORK</h2>
        ...
        <section style="background-image: url('images/ba13.jpg');background-repeat: no-repeat;background-size: cover;">
      <div class="container-lg">
        <div class="row">
          <div class="col-lg-6 pt-5 mt-5">
            <h2 class="display-1 ls-1"><span class="fw-bold text-primary">SMYM</span><span class="text-light">KOOVAPPALLY</span></h2>
            <p class="fs-4">                               </p>
            <div class="d-flex gap-3">
              <a href="https://www.youtube.com/live/Ry6YC3q8B24?si=Kiajip5fk-S3r62s" class="btn btn-primary text-uppercase fs-6 rounded-pill px-4 py-3 mt-3">YOUTUBE</a>
              <a href="https://www.youtube.com/live/Ry6YC3q8B24?si=Kiajip5fk-S3r62s" class="btn btn-dark text-uppercase fs-6 rounded-pill px-4 py-3 mt-3">Join Now</a>
            </div>
            <div class="row my-5">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="section-header d-flex flex-wrap justify-content-between my-4">
              ...
              <h2 class="section-title">HESED</h2>
